...
DATABASE_NAME = '/var/lib/nagcat/railroad/db/db'             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'vju^e)gev@7ycnir9-6s-c)kx!q=6yo!w@u61yx#gom!-jgr1p'
...
TEMPLATE_DIRS = (
    ...
    '/var/lib/nagcat/railroad/templates',
)
